...
CREATE POLICY "Lecture publique pays" ON pays FOR SELECT USING (true);
CREATE POLICY "Contrôle complet pays" ON pays FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet villes" ON villes FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet exploitations" ON exploitations FOR ALL USING (true);
...
ALTER TABLE sites_agricoles ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet sites_agricoles" ON sites_agricoles FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet champs" ON champs FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet parcelles" ON parcelles FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet campagnes" ON campagnes FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet cultures" ON cultures FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet interventions" ON interventions FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet recoltes" ON recoltes FOR ALL USING (true);
...
ALTER TABLE incidents_agricoles ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet incidents_agricoles" ON incidents_agricoles FOR ALL USING (true);
...
ALTER TABLE sites_elevage ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet sites_elevage" ON sites_elevage FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet batiments" ON batiments FOR ALL USING (true);
...
ALTER TABLE troupeaux ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet troupeaux" ON troupeaux FOR ALL USING (true);
...
ALTER TABLE cycles_production_elevage ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet cycles_production_elevage" ON cycles_production_elevage FOR ALL USING (true);
...
ALTER TABLE traitements_elevage ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet traitements_elevage" ON traitements_elevage FOR ALL USING (true);
...
ALTER TABLE aliments_elevage ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet aliments_elevage" ON aliments_elevage FOR ALL USING (true);
...
ALTER TABLE vaccinations_elevage ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet vaccinations_elevage" ON vaccinations_elevage FOR ALL USING (true);
...
ALTER TABLE pesees_elevage ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet pesees_elevage" ON pesees_elevage FOR ALL USING (true);
...
ALTER TABLE productions_elevage ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet productions_elevage" ON productions_elevage FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet entrepots" ON entrepots FOR ALL USING (true);
...
ALTER TABLE produits_intrants ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet produits_intrants" ON produits_intrants FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet stock_lots" ON stock_lots FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet stock_mouvements" ON stock_mouvements FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet transformations" ON transformations FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet pertes_stock" ON pertes_stock FOR ALL USING (true);
...
ALTER TABLE clients_erp ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet clients_erp" ON clients_erp FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet fournisseurs" ON fournisseurs FOR ALL USING (true);
...
ALTER TABLE commandes_achats ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet commandes_achats" ON commandes_achats FOR ALL USING (true);
...
ALTER TABLE commandes_ventes ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet commandes_ventes" ON commandes_ventes FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet reglements" ON reglements FOR ALL USING (true);
...
CREATE POLICY "Lecture publique plan_comptable" ON plan_comptable_syscohada FOR SELECT USING (true);
CREATE POLICY "Contrôle complet plan_comptable" ON plan_comptable_syscohada FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet exercices_fiscaux" ON exercices_fiscaux FOR ALL USING (true);
...
CREATE POLICY "Lecture publique journaux_comptables" ON journaux_comptables FOR SELECT USING (true);
CREATE POLICY "Contrôle complet journaux" ON journaux_comptables FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet ecritures_comptables" ON ecritures_comptables FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet lignes_ecriture" ON lignes_ecriture FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet utilisateurs" ON utilisateurs FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet employes" ON employes FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet contrats_travail" ON contrats_travail FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet fiches_paie" ON fiches_paie FOR ALL USING (true);
...
ALTER TABLE documents_ged ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet documents_ged" ON documents_ged FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet document_versions" ON document_versions FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet document_workflows" ON document_workflows FOR ALL USING (true);
...
ALTER TABLE signatures_numeriques ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet signatures_numeriques" ON signatures_numeriques FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet equipements" ON equipements FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet plans_maintenance" ON plans_maintenance FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet ordres_travail" ON ordres_travail FOR ALL USING (true);
...
ALTER TABLE consommations_carburant ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Contrôle complet consommations_carburant" ON consommations_carburant FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet custom_entities" ON custom_entities FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet custom_field_definitions" ON custom_field_definitions FOR ALL USING (true);
...
CREATE POLICY "Contrôle complet custom_field_values" ON custom_field_values FOR ALL USING (true);
...
CREATE INDEX IF NOT EXISTS idx_exploitations_tenant ON exploitations(tenant_id);
CREATE INDEX IF NOT EXISTS idx_parcelles_site ON parcelles(site_id);
CREATE INDEX IF NOT EXISTS idx_parcelles_champ ON parcelles(champ_id);
CREATE INDEX IF NOT EXISTS idx_cultures_campagne ON cultures(campagne_id);
...
CREATE INDEX IF NOT EXISTS idx_troupeaux_batiment ON troupeaux(batiment_id);
CREATE INDEX IF NOT EXISTS idx_stock_lots_produit ON stock_lots(produit_id);
...
CREATE INDEX IF NOT EXISTS idx_lignes_ecriture_compte ON lignes_ecriture(compte);
...
CREATE INDEX IF NOT EXISTS idx_documents_ged_tenant ON documents_ged(tenant_id);
CREATE INDEX IF NOT EXISTS idx_equipements_tenant ON equipements(tenant_id);
CREATE INDEX IF NOT EXISTS idx_custom_field_values_instance ON custom_field_values(id_instance);
`;
